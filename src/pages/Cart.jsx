...
>>>>>>> 158532e (Cart Drawer: match Checkout Review card design inside drawer (title, material/size, price, qty stepper, remove, gift wrap, line subtotal); no ETA shown per request)
                    {isDrawer && (
